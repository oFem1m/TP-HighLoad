...
1. **Регистрация и авторизация**:
   ...
   - Если в день регистрируется 100 тысяч пользователей и авторизуются 170 миллионов, то дневной трафик от этих операций составит:
     - Регистрация: 100000 * 10 МБ = 1 ТБ
     - Авторизация: 170000000 * 3 МБ = 510 ТБ
...
|-----------------------------------|-------------------------------|--------------------------------|---------------------|
| Регистрация и авторизация         | 1-10 МБ                       | 170 млн                        | 511 ТБ              |
