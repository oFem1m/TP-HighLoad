...
|--------------------------------------------|--------------------------------------------------|----------------------------------------------------------------------------------------|
| **Алгоритмы сжатия данных (Gzip)** | Сжатие файлов и данных при хранении и передаче    | Позволяют уменьшить объем данных, что снижает затраты на хранение и улучшает скорость передачи.|
