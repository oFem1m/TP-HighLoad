...
### Таблица: Размер хранения в разбивке по типам данных для iCloud для пользователя с платным тарифом
...
Общий объем хранилиза iCloud может составлять около 850 млн * 17 GB = 14.45 EB (эксабайт)
