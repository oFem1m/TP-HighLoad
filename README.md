...
3. **Средний размер хранилища пользователя**: iCloud предлагает тарифные планы от 50GB до 12TB на пользователя. У 80% пользователей бесплатный тарифный план - 5GB. у 10% - 50GB, 7% - 200GB, 2% - 2TB, ~1% - 6TB, <1% - , Средний объем хранилища может составлять около 50GB, в зависимости от типа пользователей [Apple Support](https://support.apple.com/en-us/108047) [Statista](https://www.statista.com/topics/1695/cloud-computing/).
...
\frac{680 млн * 5 GB + 85 млн * 50GB + 59.5 млн * 200GB + 17 млн * 2048GB + 7.65 * 6144GB + 0.85 млн * 12288GB}{850 млн}$ 
