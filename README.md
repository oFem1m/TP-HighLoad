...
| 2TB             | 0.08%                      | 11.05 млн                |
| 6TB             | 0.019%                     | 5.1 млн                  |
| 12TB            | 0.001%                     | 0.085 млн                 |

Подсчитаем среднее значение на пользователя: 
(680 млн * 5 GB + 110.5 млн * 50 GB + 42.5 млн * 200 GB + 11.05 млн * 2,048 GB + 5.1 * 6,144 GB + 0.85 млн * 12,288 GB) / 850 млн =  81,834.6 млн GB / 850 млн = 96,276 GB, что можно округлить до 100 GB. 
...
|------------------------------------------|--------------------------------------------------------|
| **Аутентификация (вход с разных устройств)** | 1                                                  |
...
### Таблица: Размер хранения в разбивке по типам данных для iCloud

| **Тип данных**           | **Количество файлов на пользователя** | **Средний размер файла** | **Общий размер на пользователя** | **Общий размер для 850 млн пользователей (ТБ)** |
|--------------------------|---------------------------------------|--------------------------|----------------------------------|--------------------------------------------------|
| **Фотографии**            | 1,500                                | 5 MB                     | 7.5 GB                           | ~6,375,000 ТБ                                    |
| **Видео**                 | 200                                  | 150 MB                   | 30 GB                            | ~25,500,000 ТБ                                   |
| **Документы (PDF, Word)** | 500                                  | 1 MB                     | 0.5 GB                           | ~425,000 ТБ                                      |
| **Контакты**              | 1,000                                | 2 KB                     | 0.002 GB                         | ~1,700 ТБ                                        |
| **Резервные копии**       | 1 резервная копия                    | 10 GB                    | 10 GB                            | ~8,500,000 ТБ                                    |
| **Прочие файлы**          | 100                                  | 100 MB                   | 10 GB                            | ~8,500,000 ТБ                                      |
...
Общий объем хранения iCloud может составлять 850 млн * 100 GB = 85 EB (эксабайт)
